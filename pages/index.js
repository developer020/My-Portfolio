...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
        ...
        <title>Zamzam Ali | Front-end Developer</title>
    ...
    <nav className="py-10 mb-12 flex flex-col items-center md:flex-row md:justify-between dark:text-white">
        ...
        <section>
          <div>
            <img src="https://icons8.com/icon/ARlOSb6aYtFw/sheets"> <h3 className="text-3xl py-1 dark:text-white">Services I offer</h3>
