    ...
    <nav className="py-10 mb-12 flex flex-col items-center md:flex-row md:justify-between dark:text-white">
        ...
        <div className="flex flex-col items-center md:flex-row">
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 md:text-xl max-w-lg mx-auto">I leverage data and software to make everything one click away, even cooking! Just kidding, that passion project is still in the ideation phase.</p> <p>Welcome to my world!</p>
          </div>
